/*****************************************************************************\
  ...
  Clase Wonder_Wheel.Cabin_NS.NS.Side_top
\*****************************************************************************/


Wonder_Wheel_NS.Cabin_NS.Side_top = function (N) {
  this.rows = N;
  this.cols = 3;
...
inheritPrototype(Wonder_Wheel_NS.Cabin_NS.Side_top, Object3D);

Wonder_Wheel_NS.Cabin_NS.Side_top.prototype.initBuffers = function() {
...
//  this.texture_coord_buffer = [];
  ...
  for (var i = 0; i < this.rows; i++) {
    x = -.5 + i /(this.rows-1);
    // por alguna razón "extrude" anda mal con una recta en 'x'
